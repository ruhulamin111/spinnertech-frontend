                ...
                >
                    <div className="form-control ">
                        ...
                        <input
                            ...
                            className="input input-bordered w-full py-3 px-5 mt-2 mb-6 rounded-full text-black"
                            {...register("email", {
                    ...
                    <div className="form-control ">
                        ...
                        <input
                            ...
                            className="input input-bordered w-full py-3 px-4 mt-2 mb-6 rounded-full text-black"
                            {...register("password", {
